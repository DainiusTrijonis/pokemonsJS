...
const api = (0, _api.createApiClient)("https://pokeapi.co/api/v2/pokemon");
...
},{"../api/api":"8CSMP"}],"8CSMP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createApiClient", ()=>createApiClient);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
async function request(url, config) {
    const response = await (0, _axiosDefault.default).get(url, config);
